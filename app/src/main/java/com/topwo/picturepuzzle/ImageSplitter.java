...
public class ImageSplitter {
     ...
     */
    public void split(Bitmap bitmap, int piece){

        mImagePieces = new ArrayList<ImagePiece>(piece * piece);
    ...
    public ImagePiece getImagePiece(){
        if(mImagePieces.size() == 0){
            return null;
        }
        return mImagePieces.remove((int)(mImagePieces.size() * Math.random()));
    }
}
